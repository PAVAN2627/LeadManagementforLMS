        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-8 md:gap-12 mb-8 md:mb-12">
          <div>
            ...
            <p className="text-sm md:text-base text-white/90 mb-6">
              Intelligent digital solutions that blend technology, innovation, and purpose.
            </p>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="h-12 w-12 rounded-full bg-[#0A66C2] text-white flex items-center justify-center hover:scale-105 transition-transform shadow-lg"
                aria-label="LinkedIn"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="h-12 w-12 rounded-full bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#F77737] text-white flex items-center justify-center hover:scale-105 transition-transform shadow-lg"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="h-12 w-12 rounded-full bg-[#1DA1F2] text-white flex items-center justify-center hover:scale-105 transition-transform shadow-lg"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="h-12 w-12 rounded-full bg-[#181717] text-white flex items-center justify-center hover:scale-105 transition-transform shadow-lg"
                aria-label="GitHub"
              >
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/90">
              ...
              <li><Link to="/web-app-dev" className="hover:text-white transition-colors">Web & App Development</Link></li>
